...
public class Oauth2ServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public KeyPair keyPair() {
        ...
        KeyStoreKeyFactory keyStoreKeyFactory = new KeyStoreKeyFactory(new ClassPathResource("jwt.jks"), "lss123".toCharArray());
        return keyStoreKeyFactory.getKeyPair("jwt", "lss456".toCharArray());
    }
